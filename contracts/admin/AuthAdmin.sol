...
contract AuthAdmin {
    ...
    function add_user(address _address) {
        require (isCurrentAdmin(msg.sender));
    ...
    function remove_user(address _address) {
        require (isCurrentAdmin(msg.sender));
        require (user_addresses[_address]);
    ...
    function isCurrentUser(address _address) constant returns (bool) {
        return user_addresses[_address];
    }

    function isCurrentOrPastUser(address _address) constant returns (bool) {
